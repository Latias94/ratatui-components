...
use ratatui_components_datagrid::view::DataGridAction;
use ratatui_components_datagrid::view::DataGridColumn;
use ratatui_components_datagrid::view::DataGridView;
use ratatui_components_datagrid::view::DataGridViewOptions;
use std::io;
...
fn render_status(area: Rect, buf: &mut ratatui::buffer::Buffer, theme: &Theme, grid: &DataGridView) {
    ...
    let sel = match grid.selection() {
        ratatui_components_datagrid::view::Selection::None => "-".to_string(),
        ratatui_components_datagrid::view::Selection::Single(c) => {
            format!("r{} c{}", c.row, c.col)
        }
        ratatui_components_datagrid::view::Selection::Rect { start, end } => {
